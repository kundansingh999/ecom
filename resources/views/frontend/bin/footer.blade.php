<div class="bg-info">
            ...
            <div class="row">
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Shop_Smart Stories</a>
                        </li>
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Facebook</a>
                            <i class="fa-brands fa-facebook"></i>
                        </li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Whatsapp</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Instagram</a>
                        </li>
                    </ul>
                </div>

                <div class="col-6 col-md-2 mb-3">
                    <h5 style="color:black">Cosumer Policy</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Cancellation & Returns</a>
                        </li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Terms Of Use</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Security</a></li>
    ...
    <div class="text-center d-flex flex-column flex-sm-row justify-content-between">
        <ul class="list-unstyled d-flex">
            ...
            <li class="ms-3"><a class="link-dark" href="" target="_blank"><svg class="bi" width="24" height="24">
            ...
            <li class="ms-3"><a class="link-dark" href="#"><svg class="bi" width="24" height="24">
                    ...
                    </svg></a> <i class="fa-brands fa-whatsapp"></i>
